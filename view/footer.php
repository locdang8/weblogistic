<footer id="footer">
    	...
    	<div class="footer-ship">
    		<ul class="container footer-ship">
    			<li>
    	...
    	<div class="contact__container">
            <div><img src="logo.png" alt=""></div>
                <div class="noidung">
                        ...
                        <p>
                            CÔNG TY TNHH DỊCH VỤ LOGISTICS & THƯƠNG MẠI HOÀNG MINH <br>
                        </p>
                    ...
                    <div class="noidung-contact">
                        ...
                        <ul class="infor">
                            <li>
                                ...
                                <span>21/103 Lê Lai <br>
                                    Quận Ngô Quyền,Thành phố Hải Phòng <br>
                                    Việt Nam</span>
                            </li>
                            <li>
                                <span><i class="fa fa-phone"></i></span>
                                <span> 0903.455.227</span>
                            </li>
                            <li>
                                <span><i class="fa fa-envelope"></i></span>
                                <span> lexuanhung.hoangminh@gmail.com </span>
                            </li>
                        </ul>
