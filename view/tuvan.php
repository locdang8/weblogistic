...
<div class="advise container-fluid">
    <!-- image------------- -->
    <div class="advise-image text-center mt-5">
    ...
    <!-- --------------------- -->
    <!-- data -->
    <div class="advise-data container mt-2">
        <div class="advise-data-title text-center py-4">
        ...
        <div class="advise-data-grid row mt-10 mx-md-3" data-aos="fade-right">
            <div class="col-md-8">
                ...
                <div class="phan-trang container text-center row my-3">
